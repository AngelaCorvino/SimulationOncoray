...
ax.set_xlabel('Depth z direction [mm]',fontsize=24) # label for x-axis
ax.set_ylabel('Relative dose ',fontsize=24) # label for y axis
ax2.set_ylabel('$D_{a}/ D_{b}$[%]',fontsize=24) # label for y axis
ax.legend( title='',fontsize=22,loc=3,
markerscale=3)
ax2.legend( title='',fontsize=22,loc=1,markerscale=3)
ax2.grid(b=True,color='k',linestyle='-',alpha=0.2)
ax.grid(b=True,color='k',linestyle='dotted',alpha=0.2)
ax.tick_params(axis='x', which='major', labelsize=22)

ax2.tick_params(axis='y', which='major',colors='white', labelsize=22)
