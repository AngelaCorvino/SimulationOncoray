...
outputfile_topas = '/Users/angelacorvino/Documents/GitHub/SimulationOncoray/data/Single/DoseToWater_90MeVproton_PVT_7PC.csv'
...
outputfile_topas = '/Users/angelacorvino/Documents/GitHub/SimulationOncoray/data/Single/DoseToWater_90MeVproton_PVT_6PC.csv'
...
outputfile_topas = '/Users/angelacorvino/Documents/GitHub/SimulationOncoray/data/DoseToWater_90MeVproton_PVT_6PC_1PMMA.csv'
header = pd.read_csv(outputfile_topas, nrows = 7)
df = pd.read_csv(outputfile_topas, comment='#', header=None)
topas_datamatrix = np.array(df)# convert dataframe df to array
...
plt.legend(title='$E_{primary}=92.10 MeV$',fontsize=24,loc=4,markerscale=2,title_fontsize=24)
...
plt.legend(title='$D_{MS}, E_{primary}=92.10 MeV$',fontsize=24,loc=4,markerscale=2,title_fontsize=24)
plt.grid(b=True, which='major', color='k', linestyle='-',alpha=0.2)
plt.grid(b=True, which='minor', color='k', linestyle='-', alpha=0.2)
plt.minorticks_on()
plt.tick_params(axis='x', which='major', labelsize=22)
