...
def read_data_let(path):
    ...
    ys_ana_lower=(data[6])
    #sim_redose=(data[7])
    return xs,ys_iterative,ys_iterative_upper,ys_iterative_lower,ys_ana,ys_ana_upper,ys_ana_lower
...
def read_data_let_mini(path):
    ...
    ys_iterative_upper_mini=(data[2])# #Dose weighted LET ToF in kev/um analitical method
    ...
    return depth_sci,ys_iterative_mini,ys_iterative_upper_mini,ys_iterative_lower_mini,ys_ana_mini,ys_ana_upper_mini,ys_ana_lower_mini,tof_curve
...
def read_data_scintillatorsimulateddose(path):
    ...
    return depth,depth_sci,rcfdose,rcferr,dose_sci,dose_sci_upper,dose_sci_lower,ys_ana_mini,ys_ana_upper_mini,ys_ana_lower_mini
...
def read_data_scintillatorsimulateddose_it(path):
    ...
    #ys_iterative_mini=(data[14])
    #ys_iterative_upper_mini=(data[15])# #fluence weighted LET ToF in kev/um analitical method
    #ys_iterative_lower_mini=(data[16])
    #tof_curve=(data[7])

    return depth,depth_sci,rcfdose,rcferr,dose_sci,dose_sci_upper,dose_sci_lower,ys_iterative_mini,ys_iterative_upper_mini,ys_iterative_lower_mini
...
def read_data_mini(path):
    ...
    quenchedose=(data[2])
    c=(data[3])
    ys=(data[4])  #LET ToF in kev/um


    return depth_sci,realdose,quenchedose,c,ys
